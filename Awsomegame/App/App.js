...
import {isLogin, logout} from './utils/Secret';
    ...
    return (
      <TabNavigator>
        <TabNavigator.Item
          ...
          renderIcon={() => <Image style={styles.icon} source={require('../assets/img/home.png')} />}
          renderSelectedIcon={() => <Image style={styles.icon} source={require('../assets/img/home_selected.png')} />}
        ...
        <TabNavigator.Item
          ...
          renderIcon={() => <Image style={styles.icon} source={require('../assets/img/search.png')} />}
          renderSelectedIcon={() => <Image style={styles.icon} source={require('../assets/img/search_selected.png')} />}
        ...
        <TabNavigator.Item
          ...
          renderIcon={() => <Image style={styles.icon} source={require('../assets/img/add.png')} />}
          renderSelectedIcon={() => <Image style={styles.icon} source={require('../assets/img/add.png')} />}
        ...
        <TabNavigator.Item
          ...
          renderIcon={() => <Image style={styles.icon} source={require('../assets/img/alarm.png')} />}
          renderSelectedIcon={() => <Image style={styles.icon} source={require('../assets/img/alarm_selected.png')} />}
        ...
        <TabNavigator.Item
          ...
          renderIcon={() => <Image style={styles.icon} source={require('../assets/img/user.png')} />}
          renderSelectedIcon={() => <Image style={styles.icon} source={require('../assets/img/user_selected.png')} />}
