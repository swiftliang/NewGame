        ...
        <TouchableOpacity style={styles.mask} onPress={()=>{this.props.hideShareModal()}}>
          <View style={styles.innerContainer}>
            <View style={styles.logos}>
              <TouchableOpacity onPress={this.shareToTimeline}><Image style={{width: 48, height: 48}} source={require('../../assets/img/icon64_wx_logo.png')}/></TouchableOpacity>
              <TouchableOpacity onPress={this.shareToTimeline}><Image style={{width: 48, height: 48}} source={require('../../assets/img/icon_wx_moments.png')}/></TouchableOpacity>
            </View>
