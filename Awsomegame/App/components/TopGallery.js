    ...
    return (
      <Swiper style={styles.wrapper} height={180}
        ...
        <TouchableOpacity style={styles.slide} onPress={this.onPress}>
          <Image resizeMode='cover' style={styles.image} source={require('../../assets/img/tag1.jpg')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.slide}>
          <Image resizeMode='cover' style={styles.image} source={require('../../assets/img/tag2.jpg')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.slide}>
          <Image resizeMode='cover' style={styles.image} source={require('../../assets/img/tag3.jpg')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.slide}>
          <Image resizeMode='cover' style={styles.image} source={require('../../assets/img/tag2.jpg')} />
        </TouchableOpacity>
